...
from lib.keyword_search import bm25_idf_command, bm25_tf_command, build_command, idf_command, search_command, tf_command, tfidf_command
...
def main() -> None:
    ...
    match args.command:
        ...
        case "bm25tf":
            bm25tf = bm25_tf_command(args.doc_id, args.term, k1=BM25_K1)
